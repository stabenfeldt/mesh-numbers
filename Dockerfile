...
# The name of the application is numbers and while there
...
# having to CD into the /numbers folder every time would be
# lame, so instead we can set the WORKDIR to be /numbers.
#
...
# numbers/ path inside of the Docker image.
#
# It copies it to /numbers because of the WORKDIR being set.
#
...
# /numbers folder inside of the Docker image.
#
